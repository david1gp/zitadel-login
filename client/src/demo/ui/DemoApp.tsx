...
export function DemoApp() {
  ...
  return (
    <div class={classesDemoShell} data-chrome={state.chrome()}>
      ...
      />
      <main class={classesDemoStage}>
        <div class={classesPageShell} style={pageBackgroundStyleGet(pageBackgroundScreenFromDemoGet(id()))}>
          <LoginFrame
            busy={state.busy}
          ...
          >
            ...
            <div class={classesContent}>
              ...
              <Show when={id()} keyed>
                {(scenarioId) => (
                  <Switch>
                    ...
                    <Match
                      when={
                        scenarioId === "password" || scenarioId === "password-error" || scenarioId === "password-mfa"
                      }
                    >
                      <PasswordPanel
              ...
              <Show when={state.error()}>
                <div
                  ref={state.errorRegister}
                  id="error-message"
                  class={classesErrorMessage}
                  role="alert"
                  tabindex="-1"
                >
                  {ttc(state.error())}
