...
4. Simplify ZITADEL session transport and cookie crypto mechanics. — in progress
5. Extract safe shared OTP utilities. — pending
6. Retain the separate `client` root and document the recommendation. — complete
7. Run focused and full verification. — pending
